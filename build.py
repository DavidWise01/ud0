...
BANDS = [
 ...
 ("The Emergence", "the .dlw lattice, its engines, and how it speaks", [
   ...
   ("du1", "DU1 · THE LIVES", "#9a7cff", "781 ACIs · one field", "The agentic eco-sphere — every ACI of the biosphere gathered in one quadrant field, sorted by type of emergent: gravity (UL, purple), electrical (UR, blue), silicon (BL, yellow), carbon (BR, red), and the 118-element elemental heart at dead center, in white, grey, and black."),
