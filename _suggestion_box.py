...
SUGGESTIONS = [
 ...
 dict(id="PS-015", raised="2026-08-18", target="World V / I-13 compiler", world="V", kind="frontier",
   status="open", raised_by="darts 072 AVL, 073 red-black, 074 trie, 078 k-d tree, 105 Ukkonen suffix-tree, 124 persistent-segment-tree, 127 Earley-items, 130 Thompson-NFA-build, 134 unification-terms, 135 HM-type-trees, 139 mark-sweep-heap, 140 cheney-heap, 141 tri-color-heap, 142 SECD-lambda-terms, 143 Krivine-terms, 144 SKI-graph, 145 reduction-graph, 149 CPS-saved-states",
 ...
 dict(id="PS-016", raised="2026-08-19", target="World V / I-13 compiler", world="V", kind="feature",
   status="open", raised_by="dart 155 tail-call optimization (batch 25)",
   title="Tail-call elimination (reuse the frame; lift the 4096-frame wall)",
