...
SUGGESTIONS = [
 ...
 dict(id="PS-015", raised="2026-08-18", target="World V / I-13 compiler", world="V", kind="frontier",
   status="open", raised_by="darts 072 AVL, 073 red-black, 074 trie, 078 k-d tree, 105 Ukkonen suffix-tree, 124 persistent-segment-tree",
